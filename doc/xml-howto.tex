...
% $Id: xml-howto.tex,v 1.16 2002/05/15 15:14:04 akuchling Exp $

% TODO:
%   Write outline of entire document
%   Explain namespaces somewhere
% XXX not covered: xml.marshal, scripts, namespaces, TREX/schemas, XSLT
...
Consult the XPath Recommendation (listed in
section~\ref{section-xpath-links}, ``Related Links'') for the full
syntax and grammar.
