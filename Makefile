...
perf:	build
	cd test && PYTHONPATH=$(LIBPREFIX)-2.0 python2.0 perf_expatbuilder.py
	cd test && PYTHONPATH=$(LIBPREFIX)-2.1 python2.1 perf_expatbuilder.py
	cd test && PYTHONPATH=$(LIBPREFIX)-2.2 python2.2 perf_expatbuilder.py
	cd test && PYTHONPATH=$(LIBPREFIX)-2.3 python2.3 perf_expatbuilder.py
