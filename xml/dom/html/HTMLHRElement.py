########################################################################
#
# File Name:            HTMLHRElement.py
#
# Documentation:        http://docs.4suite.com/4DOM/HTMLHRElement.py.html
#
# History:
# $Log: HTMLHRElement.py,v $
...
rwattrs = ('align', 'noShade', 'size', 'width')

class HTMLHRElement(HTMLElement):

    def __init__(self, ownerDocument, nodeName='HR'):
        HTMLElement.__init__(self, ownerDocument, "HR", nodeName)
    ...
    def _get_noShade(self):
        return (self.getAttributeNode('NOSHADE') and 1) or 0

    def _set_noShade(self,noshade):
        if noshade:
            self.setAttribute('NOSHADE', '1')
        else:
