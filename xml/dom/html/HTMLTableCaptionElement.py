########################################################################
#
# File Name:            HTMLTableCaptionElement.py
#
# Documentation:        http://docs.4suite.com/4DOM/HTMLTableCaptionElement.py.html
#
# History:
# $Log: HTMLTableCaptionElement.py,v $
...
class HTMLTableCaptionElement(HTMLElement):
    ...
    def __init__(self, ownerDocument, nodeName='CAPTION'):
        HTMLElement.__init__(self, ownerDocument, "CAPTION", nodeName)
...
#--- (end HTMLTableCaptionElement.py) ---
