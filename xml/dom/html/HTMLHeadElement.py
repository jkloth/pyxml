########################################################################
#
# File Name:            HTMLHeadElement.py
#
# Documentation:        http://docs.4suite.com/4DOM/HTMLHeadElement.py.html
#
# History:
# $Log: HTMLHeadElement.py,v $
...
class HTMLHeadElement(HTMLElement):
    ...
    def __init__(self, ownerDocument, nodeName='HEAD'):
        HTMLElement.__init__(self, ownerDocument, "HEAD", nodeName)
