...
def test():
	...
	d._set_referrer('TEST')
	if d._get_referrer() != 'TEST':
		error('getReferrer failed');

	print 'referrer works'

	print 'testing domain'
	d._set_domain('TEST')
	if d._get_domain() != 'TEST':
		error('getDomain failed');

	print 'domain works'

	print 'testing URL'
	d._set_URL('TEST_URL')
	if d._get_URL() != 'TEST_URL':
		error('getURL failed');
