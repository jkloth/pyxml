########################################################################
#
# File Name:            HTMLIsIndexElement.py
#
# Documentation:        http://docs.4suite.com/4DOM/HTMLIsIndexElement.py.html
#
# History:
# $Log: HTMLIsIndexElement.py,v $
...
class HTMLIsIndexElement(HTMLFormBasedElement):

    def __init__(self, ownerDocument, nodeName='ISINDEX'):
        HTMLFormBasedElement.__init__(self, ownerDocument, "ISINDEX", nodeName)
