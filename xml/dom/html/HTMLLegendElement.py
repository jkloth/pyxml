########################################################################
#
# File Name:            HTMLLegendElement.py
#
# Documentation:        http://docs.4suite.com/4DOM/HTMLLegendElement.py.html
#
# History:
# $Log: HTMLLegendElement.py,v $
...
rwattrs = ('accessKey', 'align')
rattrs = ('form',)

class HTMLLegendElement(HTMLFormBasedElement):

    def __init__(self, ownerDocument, nodeName='LEGEND'):
        HTMLFormBasedElement.__init__(self, ownerDocument, "LEGEND", nodeName)
