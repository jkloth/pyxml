########################################################################
#
# File Name:            HTMLBlockquoteElement.py
#
# Documentation:        http://docs.4suite.com/4DOM/HTMLBlockquoteElement.py.html
#
# History:
# $Log: HTMLBlockquoteElement.py,v $
...
class HTMLBlockquoteElement(HTMLElement):

    def __init__(self, ownerDocument, nodeName='BLOCKQUOTE'):
        HTMLElement.__init__(self, ownerDocument, 'BLOCKQUOTE', nodeName)

    def _get_cite(self):
        return self.getAttribute('CITE')

    def _set_cite(self,cite):
