########################################################################
#
# File Name:            HTMLParagraphElement.py
#
# Documentation:        http://docs.4suite.com/4DOM/HTMLParagraphElement.py.html
#
# History:
# $Log: HTMLParagraphElement.py,v $
...
class HTMLParagraphElement(HTMLElement):
    ...
    def __init__(self, ownerDocument, nodeName='P'):
        HTMLElement.__init__(self, ownerDocument, "P", nodeName)
