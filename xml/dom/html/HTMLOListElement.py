########################################################################
#
# File Name:            HTMLOListElement.py
#
# Documentation:        http://docs.4suite.com/4DOM/HTMLOListElement.py.html
#
# History:
# $Log: HTMLOListElement.py,v $
# Revision 1.1  2000/06/06 01:36:08  amkcvs
# Added 4DOM code as provided; I haven't tested it to see if something
#    broke in the process.
#
# Revision 1.19  2000/05/24 18:48:11  molson
...
rwattrs = ('compact', 'start', 'type')

class HTMLOListElement(HTMLElement):

    def __init__(self, ownerDocument, nodeName='OL'):
        HTMLElement.__init__(self, ownerDocument, "OL", nodeName)
    ...
    def _get_start(self):
        rt = self.getAttribute('START')
        if rt != '':
            return string.atoi(rt)
        return -1

    def _set_start(self,start):
        self.setAttribute('START',str(start))
