########################################################################
#
# File Name:            HTMLMenuElement.py
#
# Documentation:        http://docs.4suite.com/4DOM/HTMLMenuElement.py.html
#
# History:
# $Log: HTMLMenuElement.py,v $
...
class HTMLMenuElement(HTMLElement):
    ...
    def __init__(self, ownerDocument, nodeName='MENU'):
        HTMLElement.__init__(self, ownerDocument, "MENU", nodeName)
