########################################################################
#
# File Name:            HTMLBRElement.py
#
# Documentation:        http://docs.4suite.com/4DOM/HTMLBRElement.py.html
#
# History:
# $Log: HTMLBRElement.py,v $
...
class HTMLBRElement(HTMLElement):
    ...
    def __init__(self, ownerDocument, nodeName='BR'):
        HTMLElement.__init__(self, ownerDocument, 'BR', nodeName)

    def _get_clear(self):
        return self.getAttribute('CLEAR')

    def _set_clear(self,clear):
        self.setAttribute('CLEAR',clear)
