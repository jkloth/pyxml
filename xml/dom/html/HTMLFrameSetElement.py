########################################################################
#
# File Name:            HTMLFrameSetElement.py
#
# Documentation:        http://docs.4suite.com/4DOM/HTMLFrameSetElement.py.html
#
# History:
# $Log: HTMLFrameSetElement.py,v $
...
class HTMLFrameSetElement(HTMLElement):
    ...
    def __init__(self, ownerDocument, nodeName='FRAMESET'):
        HTMLElement.__init__(self, ownerDocument, "FRAMESET", nodeName)
