########################################################################
#
# File Name:            HTMLPreElement.py
#
# Documentation:        http://docs.4suite.com/4DOM/HTMLPreElement.py.html
#
# History:
# $Log: HTMLPreElement.py,v $
...
class HTMLPreElement(HTMLElement):
    ...
    def __init__(self, ownerDocument, nodeName='PRE'):
        HTMLElement.__init__(self, ownerDocument, "PRE", nodeName)

    def _get_width(self):
        return int(self.getAttribute('WIDTH'))

    def _set_width(self,width):
        self.setAttribute('WIDTH',str(width))
