########################################################################
#
# File Name:            HTMLLIElement.py
#
# Documentation:        http://docs.4suite.com/4DOM/HTMLLIElement.py.html
#
# History:
# $Log: HTMLLIElement.py,v $
...
class HTMLLIElement(HTMLElement):
    ...
    def __init__(self, ownerDocument, nodeName='LI'):
        HTMLElement.__init__(self, ownerDocument, "LI", nodeName)
    ...
    def _get_value(self):
        return int(self.getAttribute('VALUE'))
