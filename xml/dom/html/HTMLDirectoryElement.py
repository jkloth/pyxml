########################################################################
#
# File Name:            HTMLDirectoryElement.py
#
# Documentation:        http://docs.4suite.com/4DOM/HTMLDirectoryElement.py.html
#
# History:
# $Log: HTMLDirectoryElement.py,v $
...
class HTMLDirectoryElement(HTMLElement):
    ...
    def __init__(self, ownerDocument, nodeName='DIR'):
        HTMLElement.__init__(self, ownerDocument, 'DIR', nodeName)
