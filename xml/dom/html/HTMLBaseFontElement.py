########################################################################
#
# File Name:            HTMLBaseFontElement.py
#
# Documentation:        http://docs.4suite.com/4DOM/HTMLBaseFontElement.py.html
#
# History:
# $Log: HTMLBaseFontElement.py,v $
...
class HTMLBaseFontElement(HTMLElement):
    ...
    def __init__(self, ownerDocument, nodeName='BASEFONT'):
        HTMLElement.__init__(self, ownerDocument, 'BASEFONT', nodeName)
