########################################################################
#
# File Name:            HTMLQuoteElement.py
#
# Documentation:        http://docs.4suite.com/4DOM/HTMLQuoteElement.py.html
#
# History:
# $Log: HTMLQuoteElement.py,v $
...
class HTMLQuoteElement(HTMLElement):
    ...
    def __init__(self, ownerDocument, nodeName='Q'):
        HTMLElement.__init__(self, ownerDocument, "Q", nodeName)
