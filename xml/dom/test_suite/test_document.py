def test(tester):
	...
	if imp.ownerDocument.nodeName != doc2.nodeName:
	...
	if doc.firstChild.nextSibling.data != c2.data:
	...
	if doc.firstChild.nextSibling.data != c1.data:
