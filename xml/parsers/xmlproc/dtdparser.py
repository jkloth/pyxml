...
$Id: dtdparser.py,v 1.4 2000/02/28 20:35:29 fdrake Exp $
"""
...
class DTDParser(XMLCommonParser):
        ...
        while 1:
            ...
            if litval[pos:pos+2]=="&#":
                ...
                if litval[pos+2]=="x":
                    ...
                    digs=string.atoi(litval[pos+2:endpos])
    ...
    def parse_mixed_content_model(self):
        ...
        if sep=="|" and not self.now_at("*"):
            self.report_error(3005,"*")
        elif sep=="?" and self.now_at("*"):
            # now_at silently eats the '*', since it is allowed
            pass 
    ...
    def _push_ent_stack(self):
        EntityParser._push_ent_stack(self)
